...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('refund_status')->default(\App\Models\Order::REFUND_STATUS_PENDING)->comment('退款退货状态');
            $table->string('refund_no')->unique()->nullable()->comment('退款退货单号');
            ...
            $table->string('ship_status')->default(\App\Models\Order::SHIP_STATUS_PENDING)->comment('订单物流状态');
